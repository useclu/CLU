...
<style scoped>
.account-section{display:grid;gap:10px;padding:15px;border:1px solid rgba(255,255,255,.09);border-radius:14px;background:rgba(255,255,255,.03)}.section-copy{margin-bottom:2px}.settings-kicker{font-size:calc(9px * var(--clu-text-scale,1));text-transform:uppercase;letter-spacing:.13em;color:#72d8df;font-weight:800}.section-copy h3{margin:3px 0 4px;font-size:calc(15px * var(--clu-text-scale,1))}.section-copy p{margin:0;font-size:calc(10px * var(--clu-text-scale,1));line-height:1.5;opacity:.58}.account-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.account-grid label{display:grid;gap:4px}.account-grid label.full{grid-column:1/-1}.account-grid span{font-size:calc(9px * var(--clu-text-scale,1));font-weight:800}.account-grid input{border:1px solid rgba(255,255,255,.1);border-radius:9px;background:rgba(0,0,0,.16);color:inherit;padding:9px 10px;font-size:calc(12px * var(--clu-text-scale,1))}.account-actions,.security-actions,.legal-actions{display:flex;gap:7px;flex-wrap:wrap}.account-actions button,.security-actions button,.legal-actions button,.danger-zone>button{border:1px solid rgba(255,255,255,.1);border-radius:8px;background:rgba(255,255,255,.04);color:inherit;padding:8px 10px;font-size:calc(9px * var(--clu-text-scale,1));cursor:pointer}.security-block{display:grid;gap:9px;padding:11px;border-radius:11px;background:rgba(255,255,255,.032);border:1px solid rgba(255,255,255,.07)}.security-block>div:first-child{display:grid;gap:2px}.security-block strong{font-size:calc(10px * var(--clu-text-scale,1))}.security-block small{font-size:calc(8px * var(--clu-text-scale,1));line-height:1.45;opacity:.52}.security-block code{padding:10px;border-radius:8px;background:rgba(0,0,0,.3);color:#8df1f3;font-size:calc(11px * var(--clu-text-scale,1));overflow:auto}.copy-code{justify-self:start;border:1px solid rgba(111,227,233,.26);border-radius:8px;background:rgba(111,227,233,.07);color:#8df1f3;padding:7px 10px;font-size:calc(8px * var(--clu-text-scale,1));font-weight:800;cursor:pointer}.session-list{display:grid;gap:6px}.session-row{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:8px;border-radius:8px;background:rgba(0,0,0,.12)}.session-row span{display:grid;gap:2px}.session-row b{font-size:calc(9px * var(--clu-text-scale,1))}.session-row button{border:0;background:none;color:#74dfe4;font-size:calc(8px * var(--clu-text-scale,1));cursor:pointer}.danger{color:#ff9b9b!important;border-color:rgba(255,84,84,.25)!important}.success,.error{margin:0;padding:8px 10px;border-radius:8px;font-size:calc(9px * var(--clu-text-scale,1))}.success{background:rgba(68,205,149,.08);color:#a3f1cd}.error{background:rgba(255,70,70,.08);color:#ffb2b2}@media(max-width:680px){.account-grid{grid-template-columns:1fr}.account-grid label.full{grid-column:auto}}
</style>
