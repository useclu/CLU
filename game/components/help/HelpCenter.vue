...
<style scoped>
.help-center{width:min(1040px,calc(100vw - 36px));height:min(760px,calc(100vh - 36px));border:1px solid rgba(255,255,255,.12);border-radius:20px;background:#0d161c;color:#eef6f7;box-shadow:0 30px 90px rgba(0,0,0,.55);overflow:hidden;display:grid;grid-template-rows:auto minmax(0,1fr)}.help-header{display:flex;align-items:center;justify-content:space-between;padding:16px 18px;border-bottom:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.018)}.help-header span,.article-category{font-size:9px;text-transform:uppercase;letter-spacing:.14em;color:#76dbe2;font-weight:800}.help-header h2{margin:2px 0 0;font-size:20px}.help-header>button{width:34px;height:34px;border:1px solid rgba(255,255,255,.1);border-radius:9px;background:rgba(255,255,255,.045);color:inherit;font-size:20px;cursor:pointer}.help-layout{min-height:0;display:grid;grid-template-columns:320px minmax(0,1fr)}.help-nav{min-height:0;overflow:auto;padding:14px;border-right:1px solid rgba(255,255,255,.07);scrollbar-width:thin}.help-search{height:38px;padding:0 10px;display:flex;align-items:center;gap:8px;border:1px solid rgba(255,255,255,.1);border-radius:10px;background:rgba(255,255,255,.035)}.help-search span{opacity:.55}.help-search input{width:100%;border:0;outline:0;background:transparent;color:inherit;font:inherit;font-size:11px}.help-categories{display:grid;gap:16px;margin-top:14px}.help-categories section{display:grid;gap:5px}.help-categories h3{margin:0 3px 3px;font-size:9px;text-transform:uppercase;letter-spacing:.12em;opacity:.45}.help-categories button{display:grid;gap:3px;padding:9px 10px;border:1px solid transparent;border-radius:10px;background:transparent;color:inherit;text-align:left;cursor:pointer}.help-categories button:hover{background:rgba(255,255,255,.045)}.help-categories button.active{border-color:rgba(80,211,220,.28);background:rgba(80,211,220,.09)}.help-categories strong{font-size:11px}.help-categories small{font-size:9px;line-height:1.35;opacity:.48}.empty{font-size:11px;opacity:.55}.help-article{min-height:0;overflow:auto;padding:34px 40px 44px;scrollbar-width:thin}.help-article h1{margin:5px 0 8px;font-size:30px;letter-spacing:-.025em}.article-summary{margin:0 0 24px!important;font-size:14px!important;line-height:1.55!important;color:#a8c9cd!important}.help-article>p{max-width:760px;margin:0 0 14px;font-size:12px;line-height:1.75;color:rgba(238,246,247,.74)}.help-article ul{max-width:730px;margin:18px 0 0;padding:15px 18px 15px 34px;border:1px solid rgba(255,255,255,.08);border-radius:12px;background:rgba(255,255,255,.03)}.help-article li{padding:3px 0;font-size:11px;line-height:1.55;color:rgba(238,246,247,.7)}.related{margin-top:30px;padding-top:18px;border-top:1px solid rgba(255,255,255,.08);display:grid;gap:9px}.related>span{font-size:9px;text-transform:uppercase;letter-spacing:.12em;opacity:.5}.related>div{display:flex;gap:7px;flex-wrap:wrap}.related button{padding:8px 10px;border:1px solid rgba(80,211,220,.2);border-radius:9px;background:rgba(80,211,220,.07);color:#a9eef2;cursor:pointer;font-size:10px}@media(max-width:760px){.help-layout{grid-template-columns:1fr}.help-nav{max-height:250px;border-right:0;border-bottom:1px solid rgba(255,255,255,.07)}.help-article{padding:24px 20px 32px}.help-article h1{font-size:24px}}
</style>
