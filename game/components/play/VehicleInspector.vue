...
<style scoped>
.vehicle-inspector{position:absolute;right:18px;top:96px;z-index:24;width:min(340px,calc(100vw - 36px));max-height:calc(100vh - 116px);overflow:auto;padding:16px;border:1px solid rgba(255,255,255,.14);border-radius:17px;background:rgba(8,14,19,.93);backdrop-filter:blur(18px);box-shadow:0 20px 55px rgba(0,0,0,.42);color:#eef7f8}.close{position:absolute;right:10px;top:8px;border:0;background:transparent;color:inherit;font-size:22px;cursor:pointer}.eyebrow{font-size:9px;text-transform:uppercase;letter-spacing:.13em;opacity:.5}.vehicle-title{width:100%;border:0;background:transparent;color:inherit;display:grid;grid-template-columns:11px 1fr auto;align-items:center;gap:8px;margin:7px 0 4px;padding:0;text-align:left;cursor:pointer}.vehicle-title i{width:11px;height:11px;border-radius:50%}.vehicle-title span{font-size:9px;opacity:.5}.direction{font-size:12px;opacity:.72;margin-bottom:12px}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.grid>div,.grid>button{padding:9px;border-radius:9px;background:rgba(255,255,255,.045);display:grid;gap:3px;border:0;color:inherit;text-align:left}.grid .wide{grid-column:1/-1}.grid span{font-size:9px;opacity:.5}.grid strong{font-size:13px}.next-stop{cursor:pointer;border:1px solid rgba(78,208,218,.16)!important}.next-stop small{font-size:9px;color:#83dfe5;margin-top:3px}.vehicle-inspector p{font-size:10px;line-height:1.5;opacity:.5;margin:12px 0 0}
</style>
