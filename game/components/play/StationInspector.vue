...
<style scoped>
.station-inspector{position:absolute;right:18px;bottom:18px;z-index:18;width:min(390px,calc(100vw - 36px));max-height:calc(100vh - 112px);overflow:auto;scrollbar-width:thin;padding:16px;border-radius:18px;border:1px solid rgba(255,255,255,.14);background:rgba(9,15,20,.92);backdrop-filter:blur(18px);box-shadow:0 18px 50px rgba(0,0,0,.35);color:#eef7f8}.close{position:absolute;right:10px;top:8px;border:0;background:transparent;color:inherit;font-size:24px;cursor:pointer}.inspector-head{display:flex;align-items:end;justify-content:space-between;gap:10px;padding-right:24px}.eyebrow,.section-label{font-size:9px;text-transform:uppercase;letter-spacing:.14em;opacity:.5}.line-chip{margin-top:6px;font-size:12px}.line-chip i{width:8px;height:8px;border-radius:50%;display:inline-block;margin-right:6px}.map-link{border:1px solid rgba(91,214,223,.25);background:rgba(75,194,204,.09);color:inherit;border-radius:8px;padding:6px 8px;cursor:pointer;font-size:10px}.identity-section,.service-section,.connection-section{display:grid;gap:8px;margin-top:14px}.rename{display:flex;gap:7px}.rename input{flex:1;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);color:inherit;border-radius:8px;padding:8px}.rename button,.facility button{border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.06);color:inherit;border-radius:8px;padding:7px 9px}.directions{display:grid;padding:9px;border-radius:9px;background:rgba(255,255,255,.035)}.directions span{font-size:9px;opacity:.5}.directions strong{font-size:12px;margin-top:2px}.passages{display:grid;gap:6px}.passages article{display:grid;grid-template-columns:9px 1fr auto;align-items:center;gap:8px;padding:9px;border-radius:9px;background:rgba(255,255,255,.04)}.passages i{width:8px;height:8px;border-radius:50%}.passages span{display:grid}.passages strong{font-size:11px}.passages small{font-size:9px;opacity:.45;margin-top:2px}.passages b{font-size:11px}.no-passage,.empty-connection{font-size:11px;opacity:.55}.service-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.service-actions button{border:1px solid rgba(91,214,223,.22);background:rgba(75,194,204,.09);color:inherit;border-radius:8px;padding:6px 8px;cursor:pointer;font-size:10px}.service-actions button:disabled{opacity:.35;cursor:not-allowed}.service-actions small{font-size:9px;opacity:.48}.line-badges{display:flex;flex-wrap:wrap;gap:6px}.line-badges button{display:flex;align-items:center;gap:6px;border:1px solid rgba(255,255,255,.09);background:rgba(255,255,255,.035);color:inherit;border-radius:9px;padding:5px 8px 5px 5px;cursor:pointer}.line-badges img,.line-badges b{width:26px;height:26px;border-radius:7px;display:grid;place-items:center;object-fit:contain;color:#081014;font-size:9px}.line-badges span{font-size:10px}.facility{margin-top:14px;padding:11px;border-radius:10px;background:rgba(255,255,255,.04)}.facility-head{display:flex;align-items:center;justify-content:space-between;gap:8px}.platform-state{font-size:9px;padding:4px 7px;border-radius:999px;background:rgba(255,255,255,.06)}.state-good{color:#91e2ae;background:rgba(58,166,99,.12)}.state-medium{color:#e4d47b;background:rgba(174,147,54,.12)}.state-warning{color:#efb66c;background:rgba(180,107,45,.14)}.state-critical{color:#ff8f8f;background:rgba(181,58,58,.14)}.facility p,.hint{font-size:11px;opacity:.6}.metrics-label{display:block;margin-top:15px}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:8px}.grid>div{display:grid;padding:8px;border-radius:8px;background:rgba(255,255,255,.035)}.grid span{font-size:9px;opacity:.5}.grid strong{font-size:13px;margin-top:2px}.hint{margin:10px 0 0;line-height:1.5}@media(max-height:700px){.station-inspector{top:92px;bottom:12px;max-height:none}}@media(max-width:650px){.station-inspector{left:78px;right:10px;width:auto;bottom:10px}.grid{grid-template-columns:1fr 1fr}}
</style>
