...
<style scoped>
.finance-panel{display:grid;gap:28px}.section-head,.debt-row,.scope-row,.mode-tabs{display:flex;align-items:center;gap:8px}.section-head{justify-content:space-between}.eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:.12em;opacity:.55}.section-head h2{margin:2px 0 0;font-size:24px}.summary-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.summary-grid>div{padding:12px;border-radius:10px;background:rgba(255,255,255,.045);display:grid;gap:3px}.summary-grid span{font-size:10px;opacity:.55}.summary-grid strong{font-size:14px}.negative{color:#ff9a9a!important}.cheat-info{display:grid;gap:4px;padding:12px 14px;border:1px solid rgba(245,199,82,.25);border-radius:11px;background:rgba(245,199,82,.08);color:#f3d57e}.cheat-info span{font-size:11px;line-height:1.45;color:rgba(255,255,255,.62)}.scope-row,.mode-tabs{flex-wrap:wrap;margin:12px 0 16px}.scope-row button,.mode-tabs button,.guided-grid button,.debt-row button{border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);color:inherit;border-radius:9px;padding:7px 10px;cursor:pointer}.scope-row button.active,.mode-tabs button.active,.guided-grid button.active{border-color:rgba(80,210,220,.5);background:rgba(80,210,220,.16)}.scope-row i,.line-price-list i{width:8px;height:8px;border-radius:50%;display:inline-block;margin-right:5px}.guided-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.guided-grid button{text-align:left;display:grid}.guided-grid small{opacity:.55;margin-top:3px}.price-grid,.weekday-grid,.offer-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.price-grid label,.weekday-grid label,.offer-grid label,.field,.line-price-list label{font-size:11px;display:grid;gap:4px}.price-grid input,.weekday-grid input,.offer-grid input,.field input,.line-price-list input,.debt-row input{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);color:inherit;border-radius:8px;padding:8px;min-width:0}.line-price-list{display:grid;gap:6px}.line-price-list label{grid-template-columns:1fr 100px;align-items:center}.switch-list{display:grid;gap:7px;margin:10px 0}.switch-list label{font-size:12px}.muted{font-size:12px;opacity:.65;line-height:1.5}.credit-status{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:11px;margin:18px 0 20px}.credit-status>div{padding:12px;border-radius:10px;background:rgba(255,255,255,.04);display:grid;gap:2px}.credit-status span{font-size:10px;opacity:.55}.status-warning{border-left:3px solid #e9a84f}.status-bankrupt{border-left:3px solid #d85c5c}.debt-warning,.debt-bankrupt{padding:10px;border-radius:9px;font-size:11px;line-height:1.45}.debt-warning{background:rgba(229,158,58,.12);color:#f0c476}.debt-bankrupt{background:rgba(202,68,68,.14);color:#ff9c9c}.debt-row{margin:12px 0}.debt-row input{flex:1}.debt-borrow-row .max-borrow{flex:none}.borrow-inline-error,.borrow-feedback{margin:-5px 0 10px;padding:8px 10px;border-radius:8px;font-size:10px;line-height:1.4}.borrow-inline-error,.feedback-error{background:rgba(202,68,68,.12);color:#ffaaaa}.feedback-ok{background:rgba(61,177,111,.12);color:#9fe6bd}.funding-hero{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;margin:12px 0}.funding-hero>div{padding:11px;border-radius:10px;background:rgba(79,211,220,.06);border:1px solid rgba(79,211,220,.11);display:grid;gap:2px}.funding-hero span,.funding-hero small,.funding-breakdown span{font-size:9px;opacity:.56}.funding-hero strong{font-size:13px}.funding-breakdown{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;margin:10px 0 12px}.funding-breakdown>div{display:flex;justify-content:space-between;gap:8px;padding:8px 9px;border-radius:8px;background:rgba(255,255,255,.035);font-size:10px}.funding-breakdown b{font-size:10px;color:#9fe6bd}.transactions{display:grid;gap:8px}.transactions>div{display:flex;justify-content:space-between;gap:12px;padding:11px;border-radius:9px;background:rgba(255,255,255,.035)}.transactions span{display:grid}.transactions small{opacity:.5}.income{color:#8de2b0}details{border-top:1px solid rgba(255,255,255,.07);padding-top:22px;margin-top:8px}details+details{margin-top:8px}summary{cursor:pointer;font-weight:700;margin-bottom:17px}h4{margin:18px 0 9px}.guided-grid,.price-grid,.weekday-grid,.offer-grid,.line-price-list,.switch-list{margin-bottom:16px}.line-fare-exceptions{display:grid;gap:8px;margin-top:18px;padding-top:16px;border-top:1px solid rgba(255,255,255,.07)}.line-fare-exceptions__head{display:grid;gap:3px}.line-fare-exceptions__head small{font-size:10px;opacity:.55}.line-fare-row{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:9px 10px;border-radius:9px;background:rgba(255,255,255,.035)}.line-fare-name{display:flex;align-items:center;min-width:0;font-size:11px}.line-fare-name i{width:8px;height:8px;border-radius:50%;margin-right:6px;flex:none}.line-fare-controls{display:flex;align-items:center;gap:7px}.line-fare-controls small{font-size:9px;opacity:.58;white-space:nowrap}.line-fare-controls input[type=number]{width:86px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);color:inherit;border-radius:8px;padding:7px}.line-fare-controls input[type=checkbox]{accent-color:#50d2dc}
