...
<style scoped>
.objectives-panel{display:grid;gap:13px}.section-head{display:flex;align-items:center;justify-content:space-between}.eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:.12em;opacity:.55}.section-head h2{margin:2px 0 0;font-size:24px}.intro{font-size:12px;opacity:.7}.objective-list{display:grid;gap:8px}.objective-list article{position:relative;padding:11px;border-radius:12px;background:rgba(255,255,255,.04);display:grid;gap:5px}.objective-list p{margin:0;font-size:12px;opacity:.65;padding-right:65px}.reward{position:absolute;right:10px;top:10px;font-size:10px;color:#92e6b4}.progress{height:5px;background:rgba(255,255,255,.08);border-radius:999px;overflow:hidden}.progress i{display:block;height:100%;background:currentColor;opacity:.65}.objective-list small{opacity:.55}.history{display:grid;gap:5px}.history>div{display:grid;grid-template-columns:1fr auto;gap:2px 10px;padding:7px;border-radius:8px;background:rgba(255,255,255,.03)}.history small{opacity:.5}details{border-top:1px solid rgba(255,255,255,.07);padding-top:8px}summary{cursor:pointer;font-weight:700;margin-bottom:8px}.disabled-note{padding:14px;border:1px solid rgba(255,255,255,.08);border-radius:12px;background:rgba(255,255,255,.035)}
</style>
