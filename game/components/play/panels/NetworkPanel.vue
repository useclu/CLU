...
<style scoped>
.network-panel{display:grid;gap:24px}.section-head,.line-summary,.project-bar,.sub-card__head,.create-row,.button-row,.counter,.toggle-row,.scope-row{display:flex;align-items:center;gap:10px}.section-head,.line-summary,.project-bar,.sub-card__head{justify-content:space-between}.eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:.12em;opacity:.55}.section-head h2{margin:2px 0 0;font-size:24px}.pill{padding:5px 9px;border-radius:999px;background:rgba(255,255,255,.08);font-size:12px}.map-hint,.project-bar,.create-card,.line-card,.explain-box,.sub-card,.network-overview{border:1px solid rgba(255,255,255,.09);background:rgba(13,20,26,.78);border-radius:14px}.map-hint{padding:10px 12px;color:#9ee8ef}.network-overview{padding:16px;display:grid;gap:14px}.scope-row{flex-wrap:wrap;margin-bottom:0}.scope-row button{border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.045);color:inherit;border-radius:8px;padding:6px 9px;cursor:pointer}.scope-row button.active{border-color:rgba(80,210,220,.48);background:rgba(80,210,220,.15)}.scope-row i{width:8px;height:8px;border-radius:50%;display:inline-block;margin-right:4px}.overview-metrics{margin-bottom:0}.project-bar,.create-card{padding:12px}.project-bar small{display:block;opacity:.6;margin-top:3px}.mode-grid,.choice-row{display:flex;gap:6px;flex-wrap:wrap}.mode-button,.choice-row button,.button-row button,.counter button,.station-row>button,.sub-card button{border:1px solid rgba(255,255,255,.11);background:rgba(255,255,255,.055);color:inherit;border-radius:9px;padding:7px 10px;cursor:pointer}.mode-button.active,.choice-row button.active,.primary{background:rgba(80,210,220,.18)!important;border-color:rgba(80,210,220,.5)!important}.mode-dot{width:8px;height:8px;border-radius:50%;display:inline-block;margin-right:4px}.create-row{margin-top:10px}.create-row input{flex:1}.line-card{overflow:hidden}.line-card.selected{border-color:rgba(80,210,220,.35)}.line-summary-row{display:flex;align-items:stretch}.line-summary{flex:1;min-width:0;width:100%;border:0;background:transparent;color:inherit;padding:15px 8px 15px 14px;text-align:left;cursor:pointer}.line-delete-button{flex:none;align-self:center;width:34px;height:34px;margin-right:10px;border:1px solid rgba(255,105,105,.28);border-radius:9px;background:rgba(180,50,50,.08);color:#ff7e88;font-size:14px;display:grid;place-items:center;cursor:pointer;opacity:1}.line-delete-button:hover,.line-delete-button:focus-visible{color:#ffb0b6;border-color:rgba(255,105,105,.5);background:rgba(180,50,50,.16)}.line-badge{width:38px;height:38px;display:grid;grid-template-columns:auto auto;place-content:center;gap:2px;color:#081014;font-weight:800;flex:none}.line-badge b{font-size:12px}.line-emblem{font-size:9px;line-height:1;opacity:.72}.badge-circle{border-radius:50%}.badge-rounded{border-radius:10px}.badge-square{border-radius:3px}.badge-diamond{transform:rotate(45deg);border-radius:4px}.badge-diamond>*{transform:rotate(-45deg)}.line-title{display:grid;flex:1}.line-title small{opacity:.6;margin-top:2px}.line-kpis{display:grid;text-align:right}.line-kpis small{opacity:.55}.chevron{font-size:20px;opacity:.6}.line-actions{display:flex;gap:8px;padding:0 12px 12px}.line-actions button{border:1px solid rgba(255,255,255,.11);background:rgba(255,255,255,.055);color:inherit;border-radius:9px;padding:7px 10px;cursor:pointer}.line-details{padding:10px 14px 30px;display:grid;gap:28px}.metrics-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:11px}.metrics-grid.compact{grid-template-columns:repeat(2,minmax(0,1fr))}.metrics-grid>div{padding:12px;border-radius:9px;background:rgba(255,255,255,.04);display:grid;gap:3px}.metrics-grid span{font-size:10px;opacity:.55}.metrics-grid strong{font-size:13px}.metrics-grid .wide{grid-column:span 2}.explain-box{padding:10px;display:grid;gap:4px}.explain-box span,.muted{font-size:12px;opacity:.65}.line-diagram{padding:14px;border:1px solid rgba(255,255,255,.08);border-radius:12px;background:rgba(255,255,255,.025)}.diagram-head{display:flex;align-items:flex-end;justify-content:space-between;gap:10px;margin-bottom:11px}.diagram-head small{font-size:10px;opacity:.5;text-align:right}.diagram-stations{display:grid}.diagram-branch{margin-top:10px;padding:9px 9px 5px;border-radius:9px;background:rgba(255,255,255,.025);border-left:2px solid rgba(255,255,255,.13)}.branch-label{display:block;margin:0 0 5px 4px;font-size:9px;opacity:.5}.diagram-stop{border:0;background:transparent;color:inherit;display:grid;grid-template-columns:22px minmax(0,1fr) minmax(0,140px);align-items:center;min-height:38px;text-align:left;cursor:pointer;padding:0}.diagram-rail{align-self:stretch;position:relative;display:grid;place-items:center}.diagram-rail:before{content:'';position:absolute;top:0;bottom:0;width:3px;background:rgba(255,255,255,.14)}.diagram-stop:first-child .diagram-rail:before{top:50%}.diagram-stop:last-child .diagram-rail:before{bottom:50%}.diagram-rail i{position:relative;z-index:1;width:10px;height:10px;border:3px solid;border-radius:50%;box-shadow:0 0 0 2px #0e171d}.diagram-copy{display:grid;gap:1px;min-width:0;padding:5px 0}.diagram-copy strong{font-size:11px;overflow-wrap:anywhere}.diagram-copy small{font-size:8px;text-transform:uppercase;letter-spacing:.08em;opacity:.45}.diagram-connections{display:flex;gap:4px;flex-wrap:wrap;justify-content:flex-end;align-content:center;max-width:140px}.diagram-badge,.diagram-badge img,.diagram-badge b{width:25px;height:25px;border-radius:7px;display:grid;place-items:center}.diagram-badge{border:0;padding:0;background:transparent;cursor:pointer}.diagram-badge img{object-fit:contain;background:#fff}.diagram-badge b{font-size:8px;color:#081014}.diagnostic-list{display:grid;gap:9px}.diagnostic-title{font-size:12px;margin-bottom:2px}.diagnostic-card{padding:11px;border-radius:10px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.03);display:grid;gap:7px}.diagnostic-card>div{display:grid;gap:3px}.diagnostic-card span,.diagnostic-card small{font-size:10px;line-height:1.45;opacity:.62}.diagnostic-card small{padding-top:6px;border-top:1px solid rgba(255,255,255,.06);opacity:.78}.fleet-adjuster{display:grid;grid-template-columns:auto minmax(120px,1fr) auto auto;align-items:center;gap:7px;margin-top:10px}.fleet-adjuster>span{font-size:10px;opacity:.62}.fleet-adjuster .counter{margin:0}.fleet-adjuster input{width:62px;min-width:0;text-align:center;background:#121c23;color:inherit;border:1px solid rgba(255,255,255,.12);border-radius:8px;padding:7px}.fleet-adjuster>button{white-space:nowrap}.diag-critical{border-color:rgba(235,91,91,.32);background:rgba(180,50,50,.055)}.diag-warning{border-color:rgba(231,171,74,.24);background:rgba(177,118,40,.045)}.diag-good{border-color:rgba(77,208,138,.2);background:rgba(48,159,102,.045)}details{border-top:1px solid rgba(255,255,255,.07);padding-top:23px;margin-top:8px}details+details{margin-top:10px}summary{cursor:pointer;font-weight:700;margin-bottom:18px}.choice-row{margin-bottom:12px}.choice-row+.muted{margin:0 0 18px;line-height:1.55}.form-grid+.muted{margin:13px 0 0;line-height:1.55}.button-row{margin-top:14px}.toggle-row{margin:17px 0 14px}.service-profile{margin-bottom:17px}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.form-grid label{display:grid;gap:4px;font-size:11px;opacity:.75}.form-grid input,.form-grid select,.create-row input{background:#121c23;color:#edf6f7;color-scheme:dark;border:1px solid rgba(255,255,255,.12);color:inherit;border-radius:8px;padding:8px}.sub-card{padding:16px;margin-top:18px}.sub-card p{font-size:12px;opacity:.65;line-height:1.55;margin:10px 0 14px}.counter b{min-width:24px;text-align:center}.station-list{display:grid;gap:11px;margin-top:14px}.station-row{display:flex;align-items:center;gap:8px;padding:10px;border-radius:10px;background:rgba(255,255,255,.035)}.station-main{flex:1!important;text-align:left;display:grid}.station-main small{opacity:.55;margin-top:3px}.line-badge img{width:100%;height:100%;object-fit:contain;background:rgba(255,255,255,.9)}.wide-field{grid-column:1/-1}.logo-upload{display:grid;gap:7px;font-size:11px;color:#edf6f7}.logo-upload>span{opacity:.75}.logo-upload-row{display:flex;align-items:center;gap:8px}.logo-preview{width:42px;height:42px;border-radius:10px;display:grid;place-items:center;overflow:hidden;color:#081014}.logo-preview img{width:100%;height:100%;object-fit:contain;background:rgba(255,255,255,.9)}.file-button,.logo-upload-row>button{border:1px solid rgba(255,255,255,.11);background:rgba(255,255,255,.055);color:inherit;border-radius:9px;padding:8px 10px;cursor:pointer}.file-button input{display:none}.logo-upload small{opacity:.5;line-height:1.4}.danger{color:#ff9c9c!important}.empty{padding:18px;text-align:center;opacity:.6}.network-pulse{display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:12px;border-radius:11px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.025)}.network-pulse>div{display:grid;gap:3px}.network-pulse span{font-size:9px;text-transform:uppercase;letter-spacing:.08em;opacity:.5}.network-pulse strong{font-size:13px}.network-pulse small{font-size:10px;line-height:1.4;opacity:.58}.pulse-critical{border-color:rgba(236,91,91,.32);background:rgba(191,53,53,.08)}.pulse-warning{border-color:rgba(233,174,75,.25);background:rgba(192,130,40,.06)}.pulse-good{border-color:rgba(82,211,143,.22);background:rgba(44,160,103,.06)}.priority-line{border-left:1px solid rgba(255,255,255,.08);padding-left:12px}.trend-row{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.trend-row>span{display:grid;gap:2px;padding:9px;border-radius:9px;background:rgba(255,255,255,.035)}.trend-row small{font-size:9px;opacity:.5}.trend-row b{font-size:12px}.rolling-kpis{margin:12px 0 2px}.upgrade-card,.regulation-card{margin-top:14px}.upgrade-list{display:grid;gap:9px}.upgrade-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center;padding:10px;border-radius:10px;background:rgba(255,255,255,.035)}.upgrade-row>div{display:grid;gap:4px}.upgrade-row strong{font-size:11px}.upgrade-row small{font-size:9px;line-height:1.45;opacity:.56}.upgrade-row button{white-space:nowrap}.upgrade-row button:disabled,.regulation-counter button:disabled{opacity:.38;cursor:not-allowed}.regulation-counter{margin-top:13px;flex-wrap:wrap}.regulation-counter span{font-size:10px;opacity:.6}
.my-lines-heading{display:flex;align-items:center;gap:10px;margin-top:4px;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.12em;opacity:.68}.my-lines-heading i{height:1px;flex:1;background:rgba(255,255,255,.08)}.line-actions{flex-wrap:wrap}.identity-editor{margin:0 12px 6px;padding:14px;border:1px solid rgba(79,211,220,.18);border-radius:12px;background:rgba(79,211,220,.04);display:grid;gap:13px}.identity-editor__head{display:flex;align-items:end;justify-content:space-between;gap:12px}.identity-editor__head>div{display:grid;gap:2px}.identity-editor__head small{font-size:9px;opacity:.55}.identity-editor__actions{display:flex;justify-content:flex-end;gap:8px}.identity-editor__actions button{border:1px solid rgba(255,255,255,.11);background:rgba(255,255,255,.055);color:inherit;border-radius:9px;padding:8px 11px;cursor:pointer}.identity-editor__actions .primary{background:rgba(80,210,220,.18)!important;border-color:rgba(80,210,220,.5)!important}
