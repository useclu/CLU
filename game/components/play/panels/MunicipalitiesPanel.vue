...
<style scoped>
.municipality-panel{display:grid;gap:13px}.section-head{display:flex;align-items:center;justify-content:space-between}.eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:.12em;opacity:.55}.section-head h2{margin:2px 0 0;font-size:24px}.intro,.note{font-size:12px;opacity:.7}.totals{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.totals div{padding:9px;border-radius:10px;background:rgba(255,255,255,.045);display:grid;gap:3px}.totals span,.municipality-row small,.department-list small{font-size:10px;opacity:.55}.municipality-row .history-facts{margin-top:3px;opacity:.38}.department-list,.municipality-list{display:grid;gap:6px}.department-list>div,.municipality-row{padding:9px;border-radius:10px;background:rgba(255,255,255,.035)}.department-list>div{display:grid;gap:3px}.municipality-row{display:grid;grid-template-columns:1fr auto auto;align-items:center;gap:12px}.municipality-row>span{display:grid}.relation{text-align:right}.coverage{grid-template-columns:auto auto;gap:1px 5px;text-align:right}.note{padding:10px;border:1px solid rgba(255,255,255,.08);border-radius:10px}details{border-top:1px solid rgba(255,255,255,.07);padding-top:8px}summary{cursor:pointer;font-weight:700;margin-bottom:8px}
</style>
