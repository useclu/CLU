...
<style scoped>
.bilan-shell{width:min(1120px,calc(100vw - 42px));height:min(820px,calc(100vh - 42px));display:grid;grid-template-rows:auto auto minmax(0,1fr);border-radius:22px;background:#0d171d;border:1px solid rgba(255,255,255,.12);box-shadow:0 30px 100px rgba(0,0,0,.55);overflow:hidden;color:#edf6f7}.bilan-head{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding:20px 22px 15px;border-bottom:1px solid rgba(255,255,255,.06)}.eyebrow{font-size:9px;text-transform:uppercase;letter-spacing:.14em;opacity:.5}.bilan-head h2{margin:3px 0 3px;font-size:24px}.bilan-head p{margin:0;font-size:11px;opacity:.52}.close{width:38px;height:38px;border-radius:10px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);color:inherit;font-size:22px;cursor:pointer}.bilan-tabs{display:flex;gap:6px;padding:9px 16px;border-bottom:1px solid rgba(255,255,255,.06);background:rgba(255,255,255,.018)}.bilan-tabs button,.chart-switch button{border:1px solid transparent;background:transparent;color:inherit;border-radius:9px;padding:8px 11px;cursor:pointer;font-size:10px;opacity:.58}.bilan-tabs button.active,.chart-switch button.active{opacity:1;background:rgba(78,211,220,.12);border-color:rgba(78,211,220,.28)}.bilan-scroll{min-height:0;overflow:auto;padding:18px 20px 26px;scrollbar-width:thin}.migration-note{margin-bottom:14px;padding:10px 12px;border-radius:11px;border:1px solid rgba(241,183,91,.25);background:rgba(241,183,91,.07);display:grid;gap:3px}.migration-note strong{font-size:11px;color:#f4c476}.migration-note span{font-size:10px;line-height:1.45;opacity:.65}.hero-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}.hero-grid article,.stat-grid article,.records-grid article,.week-kpis article{padding:12px;border-radius:13px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.035);display:grid;gap:4px}.hero-grid span,.stat-grid span,.records-grid span,.week-kpis span{font-size:9px;opacity:.5;text-transform:uppercase;letter-spacing:.05em}.hero-grid strong{font-size:18px}.hero-grid small,.stat-grid small,.records-grid small,.week-kpis small{font-size:9px;line-height:1.4;opacity:.46}.bilan-section{margin-top:17px}.section-title,.chart-head,.week-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:12px;margin-bottom:9px}.section-title h3,.chart-head h3,.week-heading h3{margin:2px 0 0;font-size:15px}.section-title>small{font-size:9px;opacity:.42;max-width:390px;text-align:right}.stat-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.stat-grid b,.records-grid b{font-size:14px}.records-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.week-strip{display:flex;gap:7px;overflow:auto;padding:1px 1px 9px;scrollbar-width:thin}.week-strip button{flex:0 0 auto;min-width:128px;padding:9px 10px;border-radius:10px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.03);color:inherit;text-align:left;display:grid;gap:2px;cursor:pointer}.week-strip button.active{border-color:rgba(76,213,220,.42);background:rgba(76,213,220,.11)}.week-strip strong{font-size:10px}.week-strip small{font-size:8px;opacity:.46}.week-focus{margin-top:8px}.week-heading{align-items:center}.week-heading>span{font-size:9px;padding:5px 8px;border-radius:999px}.complete{background:rgba(65,173,111,.1);color:#8ce3ad}.ongoing{background:rgba(78,211,220,.1);color:#8de9ee}.reconstructed{background:rgba(232,171,76,.1);color:#efc174}.week-kpis{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:7px}.week-kpis b{font-size:13px}.week-kpis small.positive{color:#88e0ab;opacity:.9}.week-kpis small.negative{color:#ff9b9b;opacity:.9}.week-kpis small.neutral{opacity:.42}.week-two-columns{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:9px}.detail-card,.chart-card{padding:13px;border-radius:13px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.027)}.detail-card h4{margin:0 0 8px;font-size:11px}.detail-card dl{margin:0;display:grid;grid-template-columns:1fr 1fr;gap:6px}.detail-card dl div{padding:7px 8px;border-radius:8px;background:rgba(255,255,255,.035);display:flex;justify-content:space-between;gap:8px}.detail-card dt{font-size:9px;opacity:.46}.detail-card dd{margin:0;font-size:10px;font-weight:700}.detail-card p{margin:9px 0 0;font-size:9px;line-height:1.45;opacity:.48}.closing-finance{display:grid;grid-template-columns:1fr auto;gap:5px 10px;margin-top:10px;padding-top:9px;border-top:1px solid rgba(255,255,255,.06)}.closing-finance span{font-size:9px;opacity:.46}.closing-finance b{font-size:10px}.chart-card{margin-top:10px}.chart-head{align-items:center}.chart-switch{display:flex;gap:3px;flex-wrap:wrap;justify-content:flex-end}.chart-switch button{padding:5px 7px;font-size:9px}.chart-wrap{position:relative;height:210px;padding:6px 0 0 70px}.chart-scale{position:absolute;left:0;top:15px;bottom:29px;width:64px;display:flex;flex-direction:column;justify-content:space-between;align-items:flex-end}.chart-scale span{font-size:8px;opacity:.4}.chart-wrap svg{width:100%;height:190px;overflow:visible}.chart-wrap line{stroke:rgba(255,255,255,.08);stroke-width:1}.chart-wrap polyline{fill:none;stroke:#73dce2;stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.chart-wrap circle{fill:#0d171d;stroke:#8de9ee;stroke-width:3}.chart-wrap text{fill:rgba(255,255,255,.42);font-size:9px}.history-section{margin-top:0}.timeline{display:grid;gap:7px}.timeline article{display:grid;grid-template-columns:78px 1fr;gap:11px;padding:10px;border-radius:11px;border:1px solid rgba(255,255,255,.07);background:rgba(255,255,255,.025)}.timeline-day{font-size:9px;color:#83dfe5}.timeline article div{display:grid;gap:2px}.timeline strong{font-size:11px}.timeline small{font-size:9px;opacity:.48}.empty,.empty-history{padding:30px;text-align:center;opacity:.52}.empty-history{display:grid;gap:5px}.empty-history strong{font-size:13px}.empty-history span{font-size:10px}@media(max-width:980px){.hero-grid{grid-template-columns:repeat(2,1fr)}.week-kpis{grid-template-columns:repeat(3,1fr)}.stat-grid,.records-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:700px){.bilan-shell{width:calc(100vw - 20px);height:calc(100vh - 20px)}.bilan-head{padding:15px}.bilan-scroll{padding:13px}.hero-grid,.stat-grid,.records-grid,.week-kpis,.week-two-columns{grid-template-columns:1fr 1fr}.section-title{align-items:flex-start}.section-title>small{display:none}.chart-head{align-items:flex-start;flex-direction:column}.chart-switch{justify-content:flex-start}}@media(max-width:480px){.hero-grid,.stat-grid,.records-grid,.week-kpis,.week-two-columns{grid-template-columns:1fr}.bilan-tabs{overflow:auto}.chart-wrap{padding-left:52px}}
</style>
