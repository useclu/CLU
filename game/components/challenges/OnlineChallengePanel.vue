...
.online-intro{display:grid;gap:5px;padding:2px 1px 8px}.online-intro strong{font-size:calc(15px * var(--clu-text-scale,1))}.online-intro p{margin:0;max-width:620px;font-size:calc(9px * var(--clu-text-scale,1));line-height:1.55;opacity:.55}
.online-choices{display:grid;grid-template-columns:1fr 1fr;gap:10px}.online-choice{position:relative;display:grid;grid-template-columns:auto 1fr auto;gap:11px;align-items:center;min-height:94px;padding:15px;border:1px solid rgba(255,255,255,.09);border-radius:13px;background:rgba(255,255,255,.03);color:inherit;text-align:left}.online-choice--friend{cursor:pointer;border-color:rgba(234,78,86,.25);background:linear-gradient(135deg,rgba(179,37,47,.13),rgba(255,255,255,.025));transition:transform .16s ease,border-color .16s ease,background .16s ease}.online-choice--friend:hover{transform:translateY(-1px);border-color:rgba(244,87,95,.5);background:linear-gradient(135deg,rgba(199,44,54,.2),rgba(255,255,255,.035))}.online-choice>b{width:42px;height:42px;border-radius:11px;display:grid;place-items:center;background:rgba(224,67,76,.13);color:#ff9097;font-size:calc(11px * var(--clu-text-scale,1))}.online-choice>span{display:grid;gap:4px;min-width:0}.online-choice strong{font-size:calc(12px * var(--clu-text-scale,1))}.online-choice small{font-size:calc(8px * var(--clu-text-scale,1));line-height:1.45;opacity:.5}.online-choice em{align-self:start;font-style:normal;font-size:calc(7px * var(--clu-text-scale,1));text-transform:uppercase;letter-spacing:.1em;color:#ff9aa0}.online-choice>i{position:absolute;right:14px;bottom:11px;font-style:normal;font-size:calc(15px * var(--clu-text-scale,1));opacity:.6}.online-choice--coop{opacity:.62}.online-choice--coop>b{background:rgba(217,188,116,.1);color:#d9bc74}.online-choice--coop em{color:#d9bc74}
.friend-head{display:flex;align-items:center;gap:12px;padding-bottom:4px}.friend-head .back{border:1px solid rgba(255,255,255,.08);border-radius:8px;background:rgba(255,255,255,.035);color:inherit;padding:7px 9px;cursor:pointer;font-size:calc(8px * var(--clu-text-scale,1))}.friend-head>div{display:grid;gap:2px}.friend-head strong{font-size:calc(13px * var(--clu-text-scale,1))}.friend-head small{font-size:calc(8px * var(--clu-text-scale,1));opacity:.45}
.friend-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:5px}.friend-tabs button,.generate,.join button,.preview button{border:1px solid rgba(255,255,255,.09);border-radius:9px;background:rgba(255,255,255,.04);color:inherit;padding:8px 9px;cursor:pointer;font-size:calc(9px * var(--clu-text-scale,1))}.friend-tabs button.active{background:rgba(206,56,64,.15);border-color:rgba(244,87,95,.34);color:#ffb0b4}.intro{display:flex;gap:12px;padding:13px;border:1px solid rgba(236,72,80,.18);border-radius:12px;background:rgba(125,24,30,.08)}.intro>b{width:38px;height:38px;border-radius:10px;display:grid;place-items:center;background:rgba(224,67,76,.13);color:#ff9097}.intro strong{font-size:calc(13px * var(--clu-text-scale,1))}.intro p{margin:4px 0 0;font-size:calc(9px * var(--clu-text-scale,1));line-height:1.5;opacity:.55}.generate{justify-self:start;border-color:rgba(234,78,86,.34);background:rgba(200,50,59,.12);font-weight:750}.form-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.form-grid label,.join label{display:grid;gap:4px;font-size:calc(8px * var(--clu-text-scale,1));opacity:.72}.form-grid input,.form-grid select,.join textarea{width:100%;box-sizing:border-box;border:1px solid rgba(255,255,255,.1);border-radius:8px;background:#10191f;color:#eef7f8;padding:8px;font:inherit;color-scheme:dark}.modes{display:flex;align-items:center;gap:5px;flex-wrap:wrap}.modes>span{font-size:calc(8px * var(--clu-text-scale,1));opacity:.5;margin-right:4px}.modes button{border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.03);color:inherit;border-radius:7px;padding:6px 7px;font-size:calc(8px * var(--clu-text-scale,1));cursor:pointer}.modes button.active{border-color:rgba(81,210,218,.34);background:rgba(81,210,218,.11);color:#8de7eb}.preview{padding:12px;border:1px solid rgba(255,255,255,.08);border-radius:12px;background:rgba(255,255,255,.025);display:grid;gap:4px}.preview strong{font-size:calc(12px * var(--clu-text-scale,1))}.preview span{font-size:calc(9px * var(--clu-text-scale,1));opacity:.58}.preview small{font-size:calc(8px * var(--clu-text-scale,1));opacity:.4}.preview>button{justify-self:start;margin-top:5px}.preview--code textarea{margin-top:7px;width:100%;box-sizing:border-box;resize:vertical;border:1px solid rgba(255,255,255,.08);border-radius:8px;background:#091218;color:#aeeef1;padding:8px;font:calc(8px * var(--clu-text-scale,1))/1.4 ui-monospace,monospace}.preview-actions{display:flex;justify-content:flex-end;align-items:center;gap:6px}.copy-feedback{font-size:calc(8px * var(--clu-text-scale,1));color:#8ee3bd;margin-right:auto}.preview-actions .primary{border-color:rgba(232,76,84,.35);background:rgba(202,52,60,.13)}.join{display:grid;grid-template-columns:1fr auto;align-items:end;gap:8px}.error{margin:0;padding:8px;border-radius:8px;background:rgba(190,55,55,.1);color:#ffabab;font-size:calc(9px * var(--clu-text-scale,1))}
