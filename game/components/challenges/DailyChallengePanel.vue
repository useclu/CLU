...
<style scoped>
.daily-panel{display:grid;gap:14px}.daily-hero{display:grid;grid-template-columns:auto 1fr auto;gap:13px;align-items:center;padding:15px;border:1px solid rgba(245,196,67,.28);border-radius:15px;background:linear-gradient(120deg,rgba(92,65,10,.23),rgba(255,193,46,.05))}.daily-mark{width:45px;height:45px;display:grid;place-items:center;border-radius:13px;background:rgba(255,198,55,.13);color:#ffd35d;font-size:20px}.daily-hero p{margin:0 0 3px;font-size:8px;text-transform:uppercase;letter-spacing:.13em;color:#e9c65c}.daily-hero h3{margin:0;font-size:18px}.daily-hero small{font-size:9px;line-height:1.45;opacity:.55}.daily-hero>b{padding:7px 9px;border-radius:9px;background:rgba(255,204,72,.11);color:#ffe28b;font-size:11px}.daily-facts{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.daily-facts article{padding:10px;border:1px solid rgba(255,255,255,.07);border-radius:11px;background:rgba(255,255,255,.025);display:grid;gap:2px}.daily-facts span{font-size:8px;text-transform:uppercase;letter-spacing:.08em;opacity:.42}.daily-facts strong{font-size:11px}.daily-facts small{font-size:8px;opacity:.38}.daily-grid{display:grid;grid-template-columns:1.15fr .85fr;gap:10px}.daily-grid>div{padding:13px;border:1px solid rgba(255,255,255,.07);border-radius:12px;background:rgba(255,255,255,.02)}h4{margin:0 0 9px;font-size:10px;text-transform:uppercase;letter-spacing:.12em;opacity:.55}ul{list-style:none;padding:0;margin:0;display:grid;gap:8px}li{display:grid;grid-template-columns:auto 1fr;gap:7px;align-items:start}li b{font-size:10px;color:#f3d16b}li span{font-size:9px;line-height:1.45;opacity:.6}.error{padding:8px 10px;margin:0;border-radius:9px;background:rgba(190,55,55,.12);color:#ffaaaa;font-size:10px}.daily-actions{display:flex;align-items:center;justify-content:space-between;gap:12px}.daily-actions>span{font-size:8px;opacity:.38}.daily-actions button{border:1px solid rgba(245,199,72,.4);background:linear-gradient(135deg,rgba(218,166,38,.22),rgba(105,74,9,.18));color:#fff4cd;border-radius:10px;padding:10px 12px;cursor:pointer;font-size:10px;font-weight:800}.daily-actions button b{margin-left:12px}@media(max-width:720px){.daily-facts{grid-template-columns:1fr 1fr}.daily-grid{grid-template-columns:1fr}.daily-hero{grid-template-columns:auto 1fr}.daily-hero>b{grid-column:1/-1;width:max-content}.daily-actions{align-items:stretch;flex-direction:column}}
</style>
