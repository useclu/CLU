...
<style scoped>
.result-card{width:min(760px,calc(100vw - 34px));max-height:calc(100vh - 38px);overflow:auto;padding:20px;border:1px solid rgba(255,255,255,.12);border-radius:20px;background:#0e171d;box-shadow:0 30px 100px rgba(0,0,0,.58);display:grid;gap:13px}.result-card header{display:flex;align-items:start;justify-content:space-between;gap:18px}.result-card header span{font-size:8px;text-transform:uppercase;letter-spacing:.14em;color:#7de1e7}.result-card h2{margin:3px 0;font-size:24px}.result-card header p{margin:0;font-size:9px;opacity:.5}.result-card header>strong{font-size:22px;padding:8px 10px;border-radius:10px;background:rgba(255,255,255,.05)}.result-card header>strong.success{color:#91e5ad}.result-card header>strong.failed{color:#ff9b9b}.result-facts{display:grid;grid-template-columns:repeat(3,1fr);gap:7px}.result-facts article{padding:9px;border:1px solid rgba(255,255,255,.07);border-radius:10px;background:rgba(255,255,255,.025);display:grid;gap:2px}.result-facts small{font-size:8px;opacity:.42}.result-facts b{font-size:11px}.objectives{display:grid;gap:6px}.objectives article{display:flex;gap:8px;padding:9px;border:1px solid rgba(226,86,86,.12);border-radius:9px;background:rgba(180,50,50,.035)}.objectives article.met{border-color:rgba(78,202,119,.15);background:rgba(66,177,104,.04)}.objectives article>b{color:#ff8f8f}.objectives article.met>b{color:#82df9f}.objectives span{display:grid;gap:1px}.objectives strong{font-size:10px}.objectives small{font-size:8px;opacity:.45}.share{display:grid;grid-template-columns:1fr auto;gap:7px;align-items:end}.share label{display:grid;gap:4px;font-size:8px;opacity:.72}.share textarea,.compare input{width:100%;box-sizing:border-box;border:1px solid rgba(255,255,255,.09);border-radius:8px;background:#081116;color:#a9edf1;padding:8px;font:8px/1.4 ui-monospace,monospace;resize:vertical}.share button,.compare button,footer button{border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);color:inherit;border-radius:9px;padding:8px 10px;cursor:pointer;font-size:9px}.compare{display:grid;grid-template-columns:1fr auto;gap:7px}.message{margin:0;padding:8px;border-radius:8px;font-size:9px}.message.ok{background:rgba(61,170,101,.09);color:#9ae4b4}.message.error{background:rgba(190,55,55,.1);color:#ffaaaa}footer{display:flex;align-items:center;justify-content:flex-end;gap:7px;padding-top:4px;border-top:1px solid rgba(255,255,255,.06);flex-wrap:wrap}footer>div{display:grid;gap:2px;margin-right:auto;max-width:390px}footer strong{font-size:10px}footer small{font-size:8px;line-height:1.4;opacity:.48}footer .primary{border-color:rgba(76,211,220,.35);background:rgba(76,211,220,.12)}footer .ghost{opacity:.65}@media(max-width:620px){.result-facts{grid-template-columns:1fr 1fr}.share,.compare{grid-template-columns:1fr}footer{align-items:stretch;flex-direction:column}footer>div{margin-right:0}}
</style>
