 ...
 * Métro 19
 *
 * Gris clair dédié au futur indice 19.
 * La teinte pourra être ajustée indépendamment
 * des autres couleurs du réseau.
 */
export const GRIS_METRO_19: ColorChoice = {
  value: '#c8c9c7',
  label: 'Gris Métro 19',
}
...
export function findColorByValue(
  value: string | null,
  fallback: string,
): ColorChoice | null {
