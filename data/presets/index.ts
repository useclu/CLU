    ...
    case 'METRO':
      ...
      switch (index.$builtinLineIndex.index) {
        ...
        case '7bis':
          ...
          return Metros.METRO_7_bis as unknown as Project
        ...
        case '15':
          ...
          return Metros.METRO_15 as unknown as Project
        ...
        case '19':
          ...
          return Metros.METRO_19 as unknown as Project
    ...
    case 'TRAIN':
      ...
      switch (index.$builtinLineIndex.index) {
        ...
        case 'L':
          ...
          return Trains.TRAIN_L as unknown as Project
    ...
    case 'TRAM':
      ...
      switch (index.$builtinLineIndex.index) {
        ...
        case '4':
          ...
          return Trams.TRAM_4 as unknown as Project
