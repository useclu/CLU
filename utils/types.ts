export const isBranch = (element: LineElement): element is Branch =>
  '$branch' in element
...
export const isParallelBranches = (
  element: LineElement,
): element is ParallelBranches =>
  '$parallelBranches' in element

export const isVerticalSegment = (
  element: LineElement,
): element is VerticalSegment =>
  '$verticalSegment' in element

export const isAnnotation = (
  element: LineElement,
): element is Annotation =>
  '$annotation' in element

export const isStop = (
  branchElement: BranchElement,
): branchElement is Stop =>
  '$stop' in branchElement

export const isSpacer = (
  branchElement: BranchElement,
): branchElement is Spacer =>
  '$spacer' in branchElement

export const isAreaSeparator = (
  branchElement: BranchElement,
...
export const isService = (
  connection: Connection,
): connection is ServiceConnection =>
  '$serviceConnection' in connection

export const isAirport = (
  ornament: Ornament,
): ornament is AirportOrnament =>
  '$airportOrnament' in ornament

export const isAirportName = (
  ornament: Ornament,
): ornament is AirportNameOrnament =>
  '$airportNameOrnament' in ornament

export const isText = (
  ornament: Ornament,
): ornament is TextOrnament =>
  '$textOrnament' in ornament

export function isBuiltin(
  index: LineIndex | null,
): index is BuiltinLineIndex {
